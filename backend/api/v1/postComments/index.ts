...
router.post(api.POST_COMMENT, authenticate, async (req: IRequest, res) => {
    try {
...
router.patch(api.POST_COMMENT, authenticate, async (req: IRequest, res) => {
    try {
...
router.delete(api.POST_COMMENT, authenticate, async (req: IRequest, res) => {
    try {
